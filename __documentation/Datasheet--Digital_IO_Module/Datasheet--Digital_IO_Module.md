...
#### MachineLogic
The [MachineLogic](http://192.168.7.2/_pendant/vse.html) programming interface also allows for control of the Digital IO Module within its standard instruction set.
